...
void GetFiberTime_mp(double zCut, int index);
...
void* GetFiberTime(void* arg)
{
  ...
  SimpleFiberSim* tracer = new SimpleFiberSim(_zCut);
...
void GetFiberTime_mp(double zCut, int index=1)
{
  _zCut = zCut;
  ...
  */
  ...
  file->WriteTObject(hDtDz, "DtDz");
  file->WriteTObject(hWLS, "WLS");
